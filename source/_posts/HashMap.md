...
{% asset_img HashMap-1.png %}

1. HashMap实现了Cloneable，可以被克隆。

2. HashMap实现了Serializable，可以被序列化。

3. HashMap继承自AbstractMap，实现了Map接口，具有Map的所有功能。

# 存储结构

{% asset_img HashMap-2.png %}
...
4. 如果key所在的桶中的第一个元素的key与待插入的key相同，说明找到了元素，转后续流程9处理；
